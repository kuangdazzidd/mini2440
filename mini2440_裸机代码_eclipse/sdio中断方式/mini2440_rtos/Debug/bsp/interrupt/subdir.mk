...
C_SRCS += \
../bsp/interrupt/interrupt.c 

S_UPPER_SRCS += \
../bsp/interrupt/interrupt_asm.S 

OBJS += \
./bsp/interrupt/interrupt.o \
./bsp/interrupt/interrupt_asm.o 

S_UPPER_DEPS += \
./bsp/interrupt/interrupt_asm.d 

C_DEPS += \
./bsp/interrupt/interrupt.d 


# Each subdirectory must supply rules for building sources it contributes
bsp/interrupt/%.o: ../bsp/interrupt/%.c
	@echo 'Building file: $<'
...
bsp/interrupt/%.o: ../bsp/interrupt/%.S
	@echo 'Building file: $<'
